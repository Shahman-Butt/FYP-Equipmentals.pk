        ...
        <div className="product-cautions" style={{"margin-top": "20%", "margin-right": "2%"}}>
            ...
            <ul>
                <div className="d-flex flex-row" >
                    ...
                    <div>
                        <p style={{ marginLeft: "10px" }}>Always read the product description and specifications carefully before making a purchase. Make sure that the product you are buying meets your requirements.
                        </p>
                    </div>
                </div>
                <div className="d-flex flex-row" >
