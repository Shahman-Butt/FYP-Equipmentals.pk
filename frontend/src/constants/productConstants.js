...
export const UPDATE_ARCHIVE_REQUEST = "UPDATE_ARCHIVE_REQUEST";
export const UPDATE_ARCHIVE_SUCCESS = "UPDATE_ARCHIVE_SUCCESS";
export const UPDATE_ARCHIVE_RESET = "UPDATE_ARCHIVE_RESET";
export const UPDATE_ARCHIVE_FAIL = "UPDATE_ARCHIVE_FAIL";
